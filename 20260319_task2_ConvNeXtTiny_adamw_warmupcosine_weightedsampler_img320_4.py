...
- 不叠加 class weight，单独比较 sampler 的效果
"""
...
class Config:
    ...
    exp_name = "20260319_task2_ConvNeXtTiny_adamw_warmupcosine_weightedsampler_img320_4"
    ...
    loss_name = "CrossEntropyLoss(label_smoothing=0.1)"

    device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
    class_names = ["benign", "no_tumor"]
    model_name = "ConvNeXt-Tiny (ImageNet预训练)"
    modification = "AdamW + diff lr + warmup cosine + weakaug + WeightedRandomSampler + label smoothing + img320"
