...
def mixup_cutmix_data(images, labels, num_classes=2, mixup_alpha=0.4, cutmix_alpha=1.0, prob=0.5):
...
def train_one_epoch(model, dataloader, criterion, optimizer, device, scaler, use_amp, grad_clip=None,
    ...
    for images, labels in dataloader:
        ...
        if use_mixup and model.training:
            images, labels, soft_labels = mixup_cutmix_data(images, labels, num_classes)
