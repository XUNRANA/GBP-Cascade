"""
Exp #11: ConvNeXt-Tiny + Focal Loss + Balanced Sampler + 强增强 + 阈值优化
- 和 #10 相同策略但用 CNN，验证修复方案对 CNN 是否同样有效
"""
...
class Config:
    ...
    exp_name = "20260323_task2_ConvNeXtTiny_balanced_focal_11"
    ...
    use_amp = True
    use_mixup = False
    loss_name = "FocalLoss(gamma=2, class_weight) + BalancedSampler"
