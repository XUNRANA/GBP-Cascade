"""
Task 2 Control: ConvNeXt-Tiny 二分类 (良性肿瘤 vs 非肿瘤性息肉)
- 与当前主线 ConvNeXt img320 保持尽量一致
...
class Config:
    ...
    exp_name = "20260319_task2_ConvNeXtTiny_scratch_adamw_warmupcosine_classweight_img320_8"
    ...
    model_name = "ConvNeXt-Tiny (从零训练)"
    modification = "scratch + AdamW + diff lr + warmup cosine + weakaug + class weight + label smoothing + img320"
