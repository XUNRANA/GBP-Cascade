"""
Task 2 Baseline: ResNet18 二分类 (良性肿瘤 vs 非肿瘤性息肉)
...
class Config:
    ...
    # 实验名称和日志目录
    exp_name = "20260315_task2_Resnet18_baseline_1"
    ...
    weight_decay = 1e-4
    num_workers = 4
    eval_interval = 3  # 每隔3个epoch评估一次测试集
...
def setup_logger(log_file):
    logger = logging.getLogger("task2_baseline")
...
def main():
    ...
    logger.info(f"模型: ResNet18 (ImageNet预训练)")
    logger.info(f"修改: baseline (无数据增强，全参数微调)")
