...
class Config:
    ...
    exp_name = "20260319_task2_ConvNeXtTiny_adamw_warmupcosine_classweight_img320_seed7_5"
    ...
    modification = "AdamW + diff lr + warmup cosine + weakaug + class weight + label smoothing + img320 + seed7"
