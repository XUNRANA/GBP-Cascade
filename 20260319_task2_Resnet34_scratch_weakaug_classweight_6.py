"""
Task 2 Control: ResNet34 二分类 (良性肿瘤 vs 非肿瘤性息肉)
- 与当前最佳 ResNet34 主线保持尽量一致
- 唯一核心改动：不使用 ImageNet 预训练，直接从零开始训练
- 用于验证预训练初始化对 ResNet34 的帮助
"""
...
class Config:
    ...
    exp_name = "20260319_task2_Resnet34_scratch_weakaug_classweight_6"
...
def main():
    ...
    logger.info("模型: ResNet34 (从零训练)")
    logger.info("修改: scratch + weak augmentation + class weight + 全参数微调")
